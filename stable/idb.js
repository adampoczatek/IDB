...
(function(window) {
    ...
    window.IDB.prototype.queryMultipleKeys = function (keys, index, storeName, pageIndex, itemsPerPage, successHandler, errorHandler) {
        var instance = this,
            count = 0,
            result = [],
            limit, getNext;
        ...
        if (keys.length) {
            if (typeof pageIndex === "number" &&
                ...
                keys = keys.splice(pageIndex * itemsPerPage, itemsPerPage);
            }
